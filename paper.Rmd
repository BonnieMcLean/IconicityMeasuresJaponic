...
The stimuli were 304 words taken from the *Japonic Sensory Lexicon* database (ANONYMISED CITATION), which is a collection of words for 110 sensory concepts in 49 Japonic varities. 
...
```{r ratingconsistency,fig.cap="Consistency between participants for iconicity ratings of ideophones versus non-ideophones",out.width="70%",echo=FALSE}
